...
window.title("REGISTRATION FORM") #title
...
# database code
db = sqlite3.connect('evaluation.db') #store in variable db
cursor = db.cursor()  # cursor enables the sequential processing of rows in a result set.
cursor.execute("CREATE TABLE IF NOT EXISTS admin_registration"  #Creating table
               "(Fullname TEXT, address TEXT, username TEXT, Email TEXT, Phoneno TEXT,Gender TEXT,age TEXT , password TEXT)") 
db.commit() #fire query
...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"),bd=10, bg="#192841", fg="white")
l1.place(x=190, y=50)
...
t1 = tk.Entry(window, textvar=Fullname, width=20, font=('', 15)) #textvar used for Entry and Label,it is a variable that will be displayed as text
...
t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*") #Showing astric sign for password
t10.place(x=330, y=550)

btn = tk.Button(window, text="Register", bg="#192841",font=("",20),fg="white",bd=10, width=9, height=0, command = insert)
